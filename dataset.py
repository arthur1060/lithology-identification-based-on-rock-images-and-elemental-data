...
class Yolo_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img_path = os.path.join("E:\\deeplearning_tool\\pytorch-YOLOv4-master\\lithology-english-backup", img_path)
    ...
    def _get_val_item(self, index):
        ...
        img = cv2.imread(os.path.join("E:\\deeplearning_tool\\pytorch-YOLOv4-master\\lithology-english-backup", img_path))
        #print(os.path.join("E:\\deeplearning_tool\\pytorch-YOLOv4-master\\lithology-english-backup", img_path))
