...
Cfg.train_label = os.path.join(_BASE_DIR, 'data', 'try.txt')
Cfg.val_label = os.path.join(_BASE_DIR, 'data' ,'test-v132.txt')
...
Cfg.checkpoints = os.path.join(_BASE_DIR, 'checkpoints-430')
Cfg.TRAIN_TENSORBOARD_DIR = os.path.join(_BASE_DIR, 'log')

Cfg.iou_type = 'iou'  # 'giou', 'diou', 'ciou'

Cfg.keep_checkpoint_max = 80
